...
df_roubo_carga = df_ocorrencias[['cisp','ano','roubo_veiculo']]
df_roubo_carga = df_roubo_carga[df_roubo_carga['ano'].between(2003,2024)]
df_roubo_carga = df_roubo_carga.groupby(['cisp']).sum(['roubo_veiculo'])

# Criando o array dos roubo de carga
array_roubo_carga = np.array(df_roubo_carga["roubo_veiculo"])
...
df_roubo_carga_outliers_superiores = df_roubo_carga[df_roubo_carga['roubo_veiculo'] > limite_superior_roubo_carga]
df_roubo_carga_outliers_inferiores = df_roubo_carga[df_roubo_carga['roubo_veiculo'] < limite_inferior_roubo_carga]
...
if len(df_roubo_carga_outliers_superiores) == 0:
    ...
    print(df_roubo_carga_outliers_superiores.drop(columns='ano').sort_values(by='roubo_veiculo',ascending=False).head(5))
