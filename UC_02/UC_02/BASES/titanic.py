...
# Obetendo os quartis das passagens
...
# Identificando os valores discrepantes - outliers da passagem 
...
# Filtrando os dataframes dos valores discrepantes - outliers da passagem e da idade
df_age_outliers_superiores = df_titanic[df_titanic['Age'] > limite_superior_age]
df_age_outliers_inferior = df_titanic[df_titanic['Age'] < limite_inferior_age]

# Filtrando os dataframes dos valores discrepantes - outliers da passagem 
...
print(f'O valor do iqr - 25% do valor das idades é: {iqr_age}')
...
if len(df_age_outliers_inferior) == 0:
    print('Não existem outliiers inferiores')
else:
    print('\n -------------------- Outliers Inferiores ---------------------- ')
    print(df_age_outliers_inferior)
if len(df_age_outliers_superiores) == 0:
    print('\nNão existem outliiers superiores')
else:
    print('\n------------------- Outliers Superiores -------------------- ')
...
print(f'O valor do iqr - 25% do valor das passagens é: {iqr_fare}')
...
if len(df_fare_outliers_superiores) == 0:
    print("Não existem outliiers superiores")
else:
    print('\n ------------------- Outliers Superiores ---------------------')
